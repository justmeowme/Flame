    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCross.setOnClickListener(v -> {
            if (all_words_done == 1){
                ...
                formClose.setOnClickListener(v1 -> startActivity(new Intent(BookTestActivity.this, Level1Kitchen.class)));

                formDontClose.setOnClickListener(v12 -> alert.dismiss());
